...
/**
 * The Postcondition annotation is used to specify a constraint for a service 
 * which must hold after the service has been provided. 
 * <p>
 * The constraint itself is a simple
 * Java based predicate specified using the <i>Java Based Constraint Language 
 * (JBL)</i> whose usage is specified in the 
 * {@link org.urdad.cdd.contract org.urdad} package description.
 *
...
{
  /**
   * A name which is typically used by humans to identify the Postcondition.
   */
  String name();
